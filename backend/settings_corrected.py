"""
Django settings for backend project - VERSION CORRIGÉE
"""
...
SECRET_KEY = 'django-insecure-w1mzopy69i=bkpd!@o2x7m6()2f8(78)^40_xgpcd^r_@dbb=)'
...
# ========================================
# 🔧 REST_FRAMEWORK - CONFIGURATION CORRIGÉE
# ========================================
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # ← AJOUTÉ pour vos tokens
        'rest_framework_simplejwt.authentication.JWTAuthentication',
        'rest_framework.authentication.SessionAuthentication',
    ],
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticatedOrReadOnly',  # ← CHANGÉ ! Permet l'accès public
    ],
...
# SIMPLE_JWT - Configuration maintenue
SIMPLE_JWT = {
